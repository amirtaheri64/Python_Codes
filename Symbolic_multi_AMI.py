    ...
    if mul[j]>1 and g_freq[j][p]!=0:
      ...
      if len(der_g_new_freq)!=0:
        ...
        for i in range (0, len(result_new_freq)):
          if g_freq[j][p] != 0:
            sign.append(g_freq[j][p]/fact(mul[j]-1))
...
def AMI_arrays_out(G_init,n):
  temp1_freq = [None]*30   # auxiliary variable
  temp1_mnta = [None]*30   # auxiliary variable
  temp2_freq = [None]*30   # auxiliary variable
  temp2_mnta = [None]*30   # auxiliary variable
  temp3 = [None]*30    # auxiliary variable
  S_list = [[None]*30 for i in range(0,11)]    # auxiliary variable
  P_list_freq = [[None]*30 for i in range(0,11)]    # auxiliary variable
  P_list_mnta = [[None]*30 for i in range(0,11)]    # auxiliary variable
  S_fin = [[None]*30 for i in range(0,11)]    # auxiliary variable
  P_fin_freq = [[None]*30 for i in range(0,11)]    # auxiliary variable
  P_fin_mnta = [[None]*30 for i in range(0,11)]    # auxiliary variable
