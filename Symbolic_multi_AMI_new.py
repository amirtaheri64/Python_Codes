...
def AMI_arrays_out(G_init,n):
  temp1_freq = [None]*4   # auxiliary variable
  temp1_mnta = [None]*4   # auxiliary variable
  temp2_freq = [None]*4   # auxiliary variable
  temp2_mnta = [None]*4   # auxiliary variable
  temp3 = [None]*4    # auxiliary variable
  S_list = [[None]*4 for i in range(0,n+1)]    # auxiliary variable
  P_list_freq = [[None]*4 for i in range(0,n+1)]    # auxiliary variable
  P_list_mnta = [[None]*4 for i in range(0,n+1)]    # auxiliary variable
  S_fin = [[None]*4 for i in range(0,n+1)]    # auxiliary variable
  P_fin_freq = [[None]*4 for i in range(0,n+1)]    # auxiliary variable
  P_fin_mnta = [[None]*4 for i in range(0,n+1)]    # auxiliary variable
